...
Airbrake.prototype.expressHandler = function(setUncaughtHandler) {
  var self = this;

  if (typeof setUncaughtHandler === 'undefined') {
    setUncaughtHandler = true;
  }

  if (setUncaughtHandler) {
  ...
  return function errorHandler(err, req, res, next) {
    ...
    // Don't send to airbrake for 4XX and below error codes
